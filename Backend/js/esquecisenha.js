...
// Configurar o formulário para logar
...
function loginSucesso(usuario, lembrar) {
    ...
    setTimeout(function() {
        if (usuario.tipo === 'medico') {
            // Médico vai para dashboard-medico.html
            window.location.href = 'dashboard-medico.html';
            console.log('🔵 Redirecionando para dashboard do médico');
        } else if (usuario.tipo === 'admin') {
            // Admin pode ir para uma página administrativa (se houver)
            window.location.href = 'dashboard.html';
            console.log('🟢 Redirecionando para dashboard administrativo');
        } else {
            // Paciente vai para dashboard.html
            window.location.href = 'dashboard.html';
            console.log('🟢 Redirecionando para dashboard do paciente');
        }
    }, 1000);
}
...
// Redireciona com base no tipo de usuário (função auxiliar)
window.redirecionarPorTipo = function() {
